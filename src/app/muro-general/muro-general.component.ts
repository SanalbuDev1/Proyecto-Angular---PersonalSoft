...
@Component({
  selector: 'app-muro-general',
  templateUrl: './muro-general.component.html',
  styleUrls: ['./muro-general.component.scss']
})
export class MuroGeneralComponent implements OnInit {
  ...
  getPostSuscribe(){
    this.usuarioService.getPostAllS().subscribe(
      (respuesta:any) => {
